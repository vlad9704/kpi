				...
				<?foreach($arResult["ITEMS"] as $key=> $arItem):?>
					...
					<?endif;?>
						...
						<div class="header-slider__advantages">
							...
							{
							?>
								<div class="advantages-item wow zoomIn" data-wow-delay="<?=$delay?>s">
...
<?
//["CUSTOM_ITEMS"] = serialize($arResult["ITEMS"]);
//pre($arParams["CUSTOM_ITEMS"]);
// $dynamicArea = new \Bitrix\Main\Composite\StaticArea("header_bg");
