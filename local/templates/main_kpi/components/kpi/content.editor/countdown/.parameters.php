...
$arTemplateParameters['KPI_TEXT_RU'] = array(
      "PARENT"   => "CUSTOM_EDIT_CONTENT",
      "NAME"      => "Текст под счетчиком (RU)",
      "TYPE"      => "CUSTOM",
...
$arTemplateParameters['KPI_TEXT_KZ'] = array(
      "PARENT"   => "CUSTOM_EDIT_CONTENT",
      "NAME"      => "Текст под счетчиком (KZ)",
      "TYPE"      => "CUSTOM",
      "JS_FILE"   => "/local/components/kpi/content.editor/settings.js",
      "JS_EVENT"   => "OnTextAreaConstruct",
      "DEFAULT"   => null,
...
$arTemplateParameters['KPI_TEXT_EN'] = array(
      "PARENT"   => "CUSTOM_EDIT_CONTENT",
      "NAME"      => "Текст под счетчиком (EN)",
      "TYPE"      => "CUSTOM",
      "JS_FILE"   => "/local/components/kpi/content.editor/settings.js",
      "JS_EVENT"   => "OnTextAreaConstruct",
      "DEFAULT"   => null,
