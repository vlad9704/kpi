			...
			<div class="small-12 medium-12 large-12 column">
				<div class="block-project start">
					<div class="block-project__top">
						<div class="block-project__item wow fadeInLeft" data-wow-delay=".5s" id="<?=GetEditArea($arResult["ITEMS"]["postavshchik_propana"]);?>">
						...
						<div class="block-project__item wow fadeInLeft" data-wow-delay="1.25s" id="<?=GetEditArea($arResult["ITEMS"]["ustanovka_degidrirovaniya_propana"]);?>">
						...
						<div class="block-project__item wow fadeInLeft" data-wow-delay="2s" id="<?=GetEditArea($arResult["ITEMS"]["ustanovka_polimerizatsii_propilena"]);?>">
						...
						<div class="block-project__item wow fadeInLeft" data-wow-delay="2.75s" id="<?=GetEditArea($arResult["ITEMS"]["sbyt_gotovoy_produktsii"]);?>">
					...
					<div class="block-project__bottom">
						<div class="block-project__item wow fadeInUp" data-wow-delay="5s" id="<?=GetEditArea($arResult["ITEMS"]["ustanovka_proizvodstva_tekhnicheskikh_gazov"]);?>">
						...
						<div class="block-project__item wow fadeInUp" data-wow-delay="4.25s" id="<?=GetEditArea($arResult["ITEMS"]["gtes"]);?>">
						...
						<div class="block-project__item wow fadeInUp" data-wow-delay="3.5s" id="<?=GetEditArea($arResult["ITEMS"]["blok_vodopodgotovki_i_vodoochistki"]);?>">
